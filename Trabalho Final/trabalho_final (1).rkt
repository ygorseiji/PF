...
;;Marina Candeo Medeiros e Silva
;; Ygor Seiji Neves Nakamura
...
(define-values
  ...
  (values 0 0 0 0 60 20 300 300 300 300 1000 600 "black" "green" 30 25 0 0 0 1 15 0 #f -1 50 0.785398))
...
(define (step ws)
  (begin
    ;Update the arrow's alpha so it will disappear in the game.
    ...
    ;Make "PRESS SPACE TO START" text to fade out and in.
    ...
    (set! scn (add-line (add-line (add-line (place-image  (place-image (text/font (number->string score_1) 100 fg_color #f "roman" "normal" "bold" #f) (- (/ scn_w 2) 50) 100 (place-image (text/font (number->string score_2) 100 fg_color #f "roman" "normal" "bold" #f) (+ (/ scn_w 2) 50) 100 (place-image (text/font "TRABALHO FINAL RACKET PROF. MARCELÃO" 20 (color 255 255 255 (if (= in-game? 1) 0 (if (= in-game? 0) alpha 0))) #f "roman" "normal" "bold" #f) (/ scn_w 2) (* scn_h (/ 2 3)) (place-image (text/font "PAUSE" 100 (color 255 255 255 (if pause? 255 0)) #f "roman" "normal" "bold" #f) (/ scn_w 2) (/ scn_h 2) (place-image (rotate (* -1 (/ (* 180 (if (< b_x (/ scn_w 2)) angle (* -1 (+ 3.141592653589793 angle)))) pi)) pointer) b_x b_y (place-image (text/font "DÁ UM CLICK PARA JOGAR NOVAMENTE" 30 (color 255 255 255 (if (= in-game? 2) 255 0)) #f "roman" "normal" "bold" #f) (/ scn_w 2) (/ scn_h 2)(rectangle scn_w scn_h "solid" bg_color))))))) (/ scn_w 2) (/ scn_h 2) (empty-scene scn_w scn_h)) 15 10 (- scn_w 15) 10 (pen (color 255 255 255 150) 6 "long-dash" "butt" "bevel")) 15 (- scn_h 10) (- scn_w 15) (- scn_h 10) (pen (color 255 255 255 150) 6 "long-dash" "butt" "bevel")) (/ scn_w 2) 20 (/ scn_w 2) (- scn_h 30) (pen (color 255 255 255 150) 4 "long-dash" "butt" "bevel")))

    ;Limit the players' y position so that they won't be able to escape from the window.
    ...
    (cond
      ((= in-game? 1) (if (not pause?) (begin
                                         ;Smooth the movement of players.
